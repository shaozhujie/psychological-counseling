package com.project.counseling.config.config;

import com.project.counseling.config.filter.JwtFilter;
...
public class ShiroConfig {
    ...
    */
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        filterMap.put("/city/getConCityList", "anon");
        filterMap.put("/region/getFoodRegionList", "anon");
        filterMap.put("/book/getConBookList", "anon");
        filterMap.put("/problem/downloadExcel","anon");
        filterMap.put("/problem/import/**","anon");
        filterMap.put("/talk/saveConTalkPic/**", "anon");
